        ...
        <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4 py-12">
            <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-8 rounded-2xl shadow-xl shadow-zinc-200/40 dark:shadow-none w-full max-w-md">
                ...
                {location.state?.message && (
                    <div className="bg-blue-50 border border-blue-100 text-blue-800 dark:bg-blue-950/30 dark:border-blue-900/40 dark:text-blue-400 rounded-xl px-4 py-3 text-sm mb-5 flex items-center gap-2">
                ...
                <div className="flex items-center gap-3 mb-5">
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">or sign in with credentials</span>
                    <div className="flex-1 border-t border-zinc-100 dark:border-zinc-800" />
                </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                autoFocus
                                className="w-full pl-10 pr-4 py-2.5 border border-zinc-200 dark:border-zinc-700 rounded-xl bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white text-sm focus:outline-none focus:ring-4 focus:ring-zinc-500/5 focus:border-zinc-950 dark:focus:border-zinc-400 transition-all duration-150"
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                required
                                className="w-full pl-10 pr-10 py-2.5 border border-zinc-200 dark:border-zinc-700 rounded-xl bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white text-sm focus:outline-none focus:ring-4 focus:ring-zinc-500/5 focus:border-zinc-950 dark:focus:border-zinc-400 transition-all duration-150"
                            />
                            <button
                                type="button"
